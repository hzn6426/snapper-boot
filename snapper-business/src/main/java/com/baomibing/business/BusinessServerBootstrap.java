package com.baomibing.business;
...
@EnableFeignClients(basePackages = {"com.baomibing.feign.authority"})
@EnableScheduling
@EnableAsync
@MapperScan("com.baomibing.business.mapper")
@ComponentScan({ "com.baomibing.business.**", "com.baomibing.feign.authority.**" })
@Slf4j
